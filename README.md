...
Motivated by the software engineering technique of **[Rubber Duck Debugging](https://en.wikipedia.org/wiki/Rubber_duck_debugging)**, this project takes the concept of explaining your problems to an inanimate object to the next level. Instead of a silent yellow bath toy, you get 5 distinct personalities—from the rage-filled Gordon (Ramsay) to the existential Blues—who not only listen but debate your problems, talk back, and offer their unique "expert" opinions.
